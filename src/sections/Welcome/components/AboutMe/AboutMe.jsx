...
export function AboutMe(props) {
  return (
    <div className="about-me__wrapper">
      <p className="about-me__paragraph1">{`My interest in web development started back in 2012 when I first work in an IT companie enviroment as a trainee in Business administration.`}</p>
